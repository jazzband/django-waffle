...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Flag.custom_segment'
        db.add_column(u'waffle_flag', 'custom_segment',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Flag.custom_segment'
        db.delete_column(u'waffle_flag', 'custom_segment')
    ...
    models = {
        ...
        u'waffle.flag': {
            ...
            'custom_segment': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
