...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SessionKV'
        db.create_table(u'waffle_sessionkv', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'waffle', ['SessionKV'])

        # Adding M2M table for field session on 'Flag'
        m2m_table_name = db.shorten_name(u'waffle_flag_session')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('flag', models.ForeignKey(orm[u'waffle.flag'], null=False)),
            ('sessionkv', models.ForeignKey(orm[u'waffle.sessionkv'], null=False))
        ))
        db.create_unique(m2m_table_name, ['flag_id', 'sessionkv_id'])


    def backwards(self, orm):
        # Deleting model 'SessionKV'
        db.delete_table(u'waffle_sessionkv')

        # Removing M2M table for field session on 'Flag'
        db.delete_table(db.shorten_name(u'waffle_flag_session'))
    ...
    models = {
        ...
        u'waffle.flag': {
            ...
            'session': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['waffle.SessionKV']", 'symmetrical': 'False'}),
