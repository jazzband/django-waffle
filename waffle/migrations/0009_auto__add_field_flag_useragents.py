...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Flag.useragents'
        db.add_column('waffle_flag', 'useragents',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Flag.useragents'
        db.delete_column('waffle_flag', 'useragents')
    ...
    models = {
        ...
        'waffle.flag': {
            ...
            'useragents': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
