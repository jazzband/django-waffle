...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Flag.date_created'
        db.add_column('waffle_flag', 'date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, db_index=True), keep_default=False)

        # Adding field 'Flag.date_modified'
        db.add_column('waffle_flag', 'date_modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Flag.date_created'
        db.delete_column('waffle_flag', 'date_created')

        # Deleting field 'Flag.date_modified'
        db.delete_column('waffle_flag', 'date_modified')
