...
urlpatterns = [
    ...
    path(r'^foo_view_with_args/(?P<some_number>\d+)/', views.foo_view_with_args, name='foo_view_with_args'),
    path(r'^switched_view_with_valid_redirect',
        views.switched_view_with_valid_redirect),
    path('switched_view_with_valid_url_name',
        views.switched_view_with_valid_url_name),
    path('switched_view_with_args_with_valid_redirect/(?P<some_number>\d+)/',
        views.switched_view_with_args_with_valid_redirect),
    path('switched_view_with_args_with_valid_url_name/(?P<some_number>\d+)/',
    ...
    path('flagged_view_with_args_with_valid_redirect/(?P<some_number>\d+)/',
        views.flagged_view_with_args_with_valid_redirect),
    path('flagged_view_with_args_with_valid_url_name/(?P<some_number>\d+)/',
